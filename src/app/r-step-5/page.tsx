...
// Furnishings list with unique entries
...
// Society amenities list with unique entries
              ...
              {[
                ...
                <div key={index} className="flex justify-between items-center rounded-xl px-4 py-3 mb-3 md:ml-0 -ml-6">
                  ...
                  <div className="flex items-center md:gap-2 gap-1 md:ml-0 -ml-2">
                    <button
                      onClick={() => handleCountChange(item.key as keyof Counts, -1)}
                ...
                {furnishings.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      aria-label={`Toggle ${item.label} furnishing`}
                    >
                      <Image
                        src={item.icon}
                        alt={item.label}
                        width={40}
                        height={40}
                        className={isSelected ? "icon-selected" : "icon-unselected"}
                      />
                      <span
                  ...
                  {societyAmenities.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        aria-pressed={isSelected}
                        aria-label={`Toggle ${item.label} amenity`}
                      >
                        <Image
                          src={item.icon}
                          alt={item.label}
